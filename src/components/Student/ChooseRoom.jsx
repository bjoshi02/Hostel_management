                ...
                >
                  {
                    ...
                    hostels.map((hostel) => {
                      return <MenuItem value={hostel._id}>{ hostel.hostelName }</MenuItem>
                    })
                  }
                </Select>
              </FormControl>
            ...
            <span className={styles.formDivSecond}>
              ...
              >
                ...
                >
                  {
                    floors.map((floor) => {
                      return <MenuItem value={floor._id}>{ floor.floorNo }</MenuItem>
                    })
                  }  
                </Select>
              </FormControl>
                ...
                >
                  {
                    ...
                    rooms.map((room) => {
                      return <MenuItem value={room._id}>{ room.roomNo }</MenuItem>
                    })
                  }  
                </Select>
              </FormControl>
